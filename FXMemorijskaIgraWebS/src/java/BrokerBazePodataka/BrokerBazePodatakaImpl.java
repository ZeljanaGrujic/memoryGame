...
public class BrokerBazePodatakaImpl extends BrokerBazePodataka {
    ...
    public boolean makeConnection() {
        ...
        try {
            ...
            System.err.println("Greska prilikom povezivanja sa Bazom: poruka je :"+ex.getCause());
            return false;
        }
        return true;
    }
    ...
    public List<GeneralDObject> findRecord(GeneralDObject odo, String where) {
        ...
        try {
            ...
            System.out.println("BrokerBazePodataka.BrokerBazePodatakaImpl.findRecord() greska koja se desila: "+ex.getCause());
            Logger.getLogger(BrokerBazePodatakaImpl.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            close(null, st, rs);
        }
