...
public class JFX05 extends Application {
    ...
    public GUIMojProfil.FXMLDocumentController getController() {
        return con;
    }
    ...
    public void postaviPodatke(Korisnik vratiUlogovanogKorisnika) {

        con.postaviPodatke(vratiUlogovanogKorisnika);
    }
}
